...
var UserEntity = function () {
    ...
    return _a = /** @class */ (function () {
            function UserEntity(partial) {
                ...
                this.email = (__runInitializers(this, _createdAt_extraInitializers), __runInitializers(this, _email_initializers, void 0));
        ...
        (function () {
            ...
            _email_decorators = [(0, swagger_1.ApiProperty)({ example: 'example@mail.com' })];
            _username_decorators = [(0, swagger_1.ApiProperty)({ example: 'username' })];
